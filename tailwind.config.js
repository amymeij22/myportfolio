  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom blue-slate color palette
        slate: {
          50: "hsl(210, 40%, 98%)",
          100: "hsl(210, 40%, 96.1%)",
      ...
      backgroundImage: {
        ...
        "grid-pattern":
          "url(\"data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%239C92AC' fill-opacity='0.05' fill-rule='evenodd'%3E%3Cpath d='M0 0h40v40H0V0zm20 20h20v20H20V20zM0 20h20v20H0V20z'/%3E%3C/g%3E%3C/svg%3E\")",
      },
    },
  },
