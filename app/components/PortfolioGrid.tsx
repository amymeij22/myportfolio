...
const projects = [
  {
    ...
    description: "The Automatic Chains-D Weather Station is a prototype that uses ESP32 and LoRa technology for real-time environmental monitoring. Data is transmitted wirelessly and displayed on a web dashboard, enabling easy access to current weather conditions for remote monitoring and analysis.",
    imageUrl: "https://1h1v9ndzh4okzjrr.public.blob.vercel-storage.com/ACWS-XsKb5VAh1tjk5SeZhURMAmgJbMJ28p",
  ...
  },
  {
    ...
    description: "This is a WordPress-based website aimed at enhancing the university's online presence. This responsive and user-friendly website features an intuitive design, showcasing academic programs, faculty profiles, and student resources. It provides essential information for prospective students and the community, ensuring easy navigation and access to university services.",
    imageUrl: "https://1h1v9ndzh4okzjrr.public.blob.vercel-storage.com/stmkg-VVbpmxqJj3kueyPNmGD2CX3bjgGAvM",
    category: "Website",
  ...
  },
  {
    ...
    imageUrl: "https://1h1v9ndzh4okzjrr.public.blob.vercel-storage.com/pemira-VKjP5dddhc6J2HCpAejAcepNZRa7Pc",
    category: "Website",
    viewProjectUrl: "https://stmkg.ac.id",
  },
  {
  ...
  },
  {
    ...
    imageUrl: "https://1h1v9ndzh4okzjrr.public.blob.vercel-storage.com/Perpustakaan-djzLBPYjeHHv56jImGxwFoDFlIWrNW",
    category: "Website",
  ...
  },
  {
    ...
    description: "It is a chatbot assistant that can help you find information about STMKG. This chatbot is built using Vue.js, integrated with Gemini API and BMKG Weather - Earthquake API.", 
    imageUrl: "https://1h1v9ndzh4okzjrr.public.blob.vercel-storage.com/chatbot-kTxbEz42OoOIHfYHxNZJm7WiRylMRD",
    category: "Website",
    viewProjectUrl: "stmkg-chatbot.amymeij.web.id",
  },
  {
    id: 8,
    title: "Research",
    caption: "Explore my research paper!",
    description: "I am also an active novice researcher, having published several papers in various academic fields. My research interests focus on meteorology and climatology instruments, and I am committed to contributing to the advancement of knowledge through rigorous study and analysis. Engaging in research allows me to explore new ideas and collaborate with fellow scholars, further enriching my academic journey.",
    imageUrl: "https://1h1v9ndzh4okzjrr.public.blob.vercel-storage.com/research-d2P1GMjI6VbFhCNx1IgtP9EGrapVkS",
    category: "Other",
  ...
  },
  {
    ...
    description: "Coming Soon – Exciting new developments are on the horizon! As I prepare to launch, remember: 'Life is about creating; every step adds meaning.' Stay tuned for my journey, where each moment brings me closer to making a meaningful impact.",
    imageUrl: "https://1h1v9ndzh4okzjrr.public.blob.vercel-storage.com/ONGOING-54KphNzUwqow2jVwZyMwnxUIGRpdxx",
    category: "Other",
    viewProjectUrl: "#",
  },
]
  ...
  return (
    <section className="relative isolate overflow-hidden bg-background min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <a href={project.viewProjectUrl} className="text-primary hover:underline inline-flex items-center font-medium">
                      View Project
                      <svg
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent className="max-w-[75%] sm:max-w-3xl">
          {currentProject && (
            <>
              <DialogHeader className="text-center">
                <DialogTitle className="text-2xl font-bold text-center">{currentProject.title}</DialogTitle>
                <div className="text-sm font-medium text-primary mt-1 text-center">{currentProject.category}</div>
              </DialogHeader>
              <div className="relative w-full mb-4 overflow-hidden rounded-md mx-auto" style={{ paddingTop: "56.25%" }}>
                <Image
              ...
              <DialogDescription className="text-foreground text-base text-justify">{currentProject.description}</DialogDescription>
              <div className="flex justify-center mt-4">
                <a className="bg-primary hover:bg-primary/90 text-black dark:text-black px-4 py-2 rounded-md inline-block" href={currentProject.viewProjectUrl} target="_blank">
                  View Full Project
                </a>
              </div>
            </>
