        ...
        <motion.div ref={carousel} className="cursor-grab overflow-hidden">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className="min-w-[300px] h-[400px] p-8 m-4 bg-card rounded-3xl shadow-lg flex flex-col justify-between hover-lift transition-all duration-300 ease-in-out border border-border hover:border-primary/30"
              >
                <div>
